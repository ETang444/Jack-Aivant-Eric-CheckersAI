//This is the starting screen, where you choose a 1-player or 2-player game
//It then creates the game for you
//And the opening window disposes of itself
import java.awt.*;
...
public class CheckersDriver extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		{
			CheckersGUI game = new CheckersGUI("Human vs. Computer", false);
			game.setVisible(true);
		}
		else if(evt.getActionCommand().equals("Two Player Game"))
		{
			CheckersGUI game = new CheckersGUI("Human vs. Human", true);
			game.setVisible(true);
		}
